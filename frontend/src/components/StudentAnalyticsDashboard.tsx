...
import { 
    ...
    BarChart3, Medal, Clock, FileSpreadsheet
} from 'lucide-react';
...
export const StudentAnalyticsDashboard: React.FC<Props> = ({ data, loading, onExportExcel, onExportCSV }) => {
    ...
    // Filtros e ordenação da planilha
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-warm-200 shadow-xs">
                <div>
                    ...
                    <p className="text-xs text-warm-500 mt-1">
                        Análise de crescimento, acertos, ranking de pontos e planilha completa de alunos
                    </p>
                </div>

                <div className="flex flex-wrap items-center gap-2.5">
                    {/* Switcher de Visão: Gráficos ou Planilha */}
                    <div className="flex bg-warm-100 p-1 rounded-2xl text-xs font-bold">
                        ...
                        >
                            <FileSpreadsheet size={14} /> Planilha Completa
                        </button>
                    </div>
                    ...
                    >
                        <Download size={14} /> Excel (.xlsx) c/ Gráficos
                    </button>
