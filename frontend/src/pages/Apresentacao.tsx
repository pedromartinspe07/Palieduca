...
const Apresentacao: React.FC = () => {
    return (
        <main className="pt-24 pb-20">
            {/* Header Banner */}
            <section className="bg-nature-50 py-16 px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <h1 className="text-4xl font-bold text-slate-800 mb-6">Apresentação do Projeto</h1>
            ...
            <section className="py-16 px-4 max-w-7xl mx-auto">
                <h2 className="text-2xl font-bold text-slate-800 mb-8 text-center">Público-alvo</h2>
                <div className="grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        { title: "Profissionais", desc: "Enfermeiros e equipe da saúde visando atualização técnica.", icon: <Users className="text-nature-600" size={32} /> },
                    ].map(item => (
                        <div key={item.title} className="glassmorphism-card p-6 flex flex-col items-center text-center rounded-2xl">
                            <div className="p-4 bg-slate-50 rounded-full mb-4">{item.icon}</div>
            ...
            <section className="py-16 px-4 bg-slate-50">
                <div className="max-w-5xl mx-auto">
                    <h2 className="text-3xl font-bold text-slate-800 mb-10 text-center">Fundamentação Teórica</h2>
