        ...
        <main className="min-h-screen pt-24 pb-12 flex items-center justify-center bg-warm-50 px-4">
            <div className="max-w-md w-full glassmorphism p-8 rounded-3xl border border-warm-200 shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button 
                        type="button"
                        onClick={() => alert('Autenticação via Google será implementada quando as credenciais do Google Cloud estiverem prontas.')}
                        className="w-full bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-xl border border-gray-200 transition-all shadow-sm flex justify-center items-center gap-2"
                    >
