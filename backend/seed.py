...
def seed_users():
    ...
    usuarios_iniciais = [
        {
            "nome": "Patricia Maria de Oliveira Andrade",
            "email": "patricia@palieduca.com",
            "senha": "senha_temporaria123", # Em produção isso viria do .env
            "cargo": "dona"
        },
        {
            "nome": "Pedro Martins",
            "email": "pedro@palieduca.com",
            "senha": "senha_temporaria123",
            "cargo": "desenvolvedor"
        },
        {
            "nome": "Carlos Eduardo",
            "email": "eduardo@palieduca.com",
            "senha": "senha_temporaria123",
            "cargo": "desenvolvedor"
        }
    ]
