...
def seed_modules():
    ...
    try:
        ...
        # Dados dos módulos iniciais (sem porcentagem mockada)
        modulos = [
            {"slug_id": "fundamentos", "title": "Módulo 1 - Fundamentos", "description": "Conceitos, História, Princípios, Elegibilidade, Mitos e verdades sobre os cuidados paliativos.", "icon_name": "Stethoscope", "progress": 0, "resources": "Vídeo, Infográfico, Quiz", "image_url": "https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=800", "delay": 1},
            {"slug_id": "comunicacao", "title": "Módulo 2 - Comunicação", "description": "Comunicação terapêutica, Escuta ativa, Notícias difíceis e Relação com a família do paciente.", "icon_name": "Users", "progress": 0, "resources": "Simulações, Casos, Feedback", "image_url": "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&q=80&w=800", "delay": 2},
